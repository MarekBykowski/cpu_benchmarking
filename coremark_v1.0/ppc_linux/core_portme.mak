...
CC = powerpc-fsl_networking-linux-gcc
# Flag: CFLAGS
#	Use this flag to define compiler options. Note, you can add compiler options from the command line using XCFLAGS="other flags"
#PORT_CFLAGS = -O3 -DGNU -mhard-float -mcpu=476fp -mtune=476 -funroll-loops -fgcse-sm -falign-loops=8 -mspe=yes -DMULTITHREAD=1 -DUSE_PTHREAD
#PORT_CFLAGS = -mcpu=e6500 -m32 -O3 -mno-altivec -funroll-all-loops --param max-inline-insns-auto=300 --param case-values-threshold=30 -falign-functions=32 -fno-extelim  -lrt
PORT_CFLAGS = -mcpu=e6500 -m32 -O3 -mno-altivec -funroll-all-loops --param max-inline-insns-auto=300 --param case-values-threshold=30 -falign-functions=32 -fno-extelim -lrt -DMULTITHREAD=24 -DUSE_FORK=1
