...
*/
#include <stddef.h>  /* for ptrdiff_t which is arch dependent 32 vs 64-bit difference diff in pointer subtraction operation */
...
typedef ptrdiff_t ee_ptr_int; /* could be unsigned long long for 64-bit, but this should work for 32/64-bit */
