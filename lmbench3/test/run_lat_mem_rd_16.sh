...
taskset -c 12 lat_mem_rd -P 1 -t 640 2>&1 | tee ./results/lat_mem_rd/lat_mem_rd_16cores_core12.txt &
taskset -c 13 lat_mem_rd -P 1 -t 640 2>&1 | tee ./results/lat_mem_rd/lat_mem_rd_16cores_core13.txt &
taskset -c 14 lat_mem_rd -P 1 -t 640 2>&1 | tee ./results/lat_mem_rd/lat_mem_rd_16cores_core14.txt &
taskset -c 15 lat_mem_rd -P 1 -t 640 2>&1 | tee ./results/lat_mem_rd/lat_mem_rd_16cores_core15.txt &
wait
